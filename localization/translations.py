LANGUAGES_DICTIONARY = {
    'uk': {
        ...
        'remainder_challenge_accept_msg': 'Нагадуємо, що у вас є неприйнятий челендж. Залишилося днів, щоб прийняти або відхили челендж: {}',
        'remainder_challenge_play_msg': 'Нагадуємо, що у вас є незіграний челендж. Залишилося днів, щоб зіграти матч: {}',

        'challenge_was_ignored_msg': 'Ви проігнорували челендж. Вам зараховано технічну поразку. Всього проігноровано челенджів: {} (максимально допустимо: {})',
        'user_was_moved_to_inactive': 'Ви проігнорували надто багато челенджів. Вас переведено в стан Inactive. Для повернення до активного стану зв’яжіться з адміністрацією',
        'challenge_was_ignored_opponent_msg': 'Ваш опонент проігнорував пропозицію челенджу. Вам зараховано технічну перемогу.',

        'gsheet_technical_win_ignored_str': 'челендж проігноровано',
        'gsheet_technical_win_dismissed_str': 'повторна відмова',

        'gsheet_log_challenge_canceled': 'Челендж від гравця {} гравцю {} скасовано з технічних причин',
        'gsheet_log_challenge_canceled_no_opponent': 'Челендж від гравця {} скасовано з технічних причин',
        ...
        'gsheet_log_game_canceled': 'Гру між гравцями {} та {} скасовано',
        'gsheet_log_player_moved_to_inactive': 'Гравець {} проігнорував надто багато челенджів і був переведений до стану Inactive',
        'gsheet_log_player_started_vacation': 'Гравець {} пішов у відпустку',
        'gsheet_log_player_finished_vacation': 'Гравець {} вийшов з відпустки',
        'gsheet_log_on_injuiry_started': 'Гравець {} травмований',
        'gsheet_log_on_injuiry_ended': 'Гравець {} позбувся травми',
