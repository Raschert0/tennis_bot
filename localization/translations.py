LANGUAGES_DICTIONARY = {
    'uk': {
        'welcome_msg': 'Вітаю, {}!',
          ...
          'use_keyboard_msg': 'Використовуйте кнопки меню, будь ласка 👇',
        'message_type_not_supported_msg': 'Цей тип повідомлень не підтримується',

        'authentication_msg': 'Це офіційний бот тенісного чемпіонату Shuliavka Pyramid Open \n'
                              'Для участі просто оберіть себе зі списку гравців.\n'
                              'Якщо не можете знайти себе, напишіть адміністратору - @abezkorovainyi',
        'authentication_cannot_find_competitors_msg': 'Нових учасників турніра не знайдено 😢 \n'
                                                      'Напишіть адміністратору - @abezkorovainyi',
        'authentication_specified_competitor_not_found_clb': 'Такого учасника не знайдено 😢',

        'competitor_record_vanished_msg': 'Не вдалося знайти інформацію про учасника. Необхідно знову пройти процедуру аутентифікації',
        ...
        'menu_cancel_challenge_request_btn': '❌ Скасувати надісланий челендж',
        'menu_reply_to_challenge_request_btn': '⚔️ Відреагувати на челендж',
        ...
        'menu_moved_to_inactive_pseudo2_btn': 'Напишіть адміністратору - @abezkorovainyi',
        ...
        'menu_on_vacation_end_msg': 'Ваша відпустка закінчилася. Ви знову доступні для челенджів 🎾',
        'menu_vacation_no_days_left_msg': 'У вас не лишилося днів для відпустки в цьому місяці 👻',

        'challenge_send_msg': 'Оберіть зі списку учаника для челенджа ⬇️',
        ...
        'challenge_no_applicable_competitors_msg': 'Наразі ніхто з доступних вам учасників не може отримати челендж. Дочекайтесь завершення найближчих матчів, а також поверення гравців з відпустки чи лікарняного 🙃',
        'challenge_specified_competitor_not_found_clb': 'Такого учасника не знайдено 🔎',
        'challenge_opponent_no_longer_available_msg': 'Обраний учасник наразі недоступний для челенджа. Спробуйте іншого, будь ласка 🙏',
        'challenge_cannot_send_message_to_opponent_msg': 'Неможливо надіслати челендж, оскільки гравець відсутній у Telegram 🙈',
        ...
        'challenge_you_are_challenged_passive_msg': '<a href="tg://user?id={}">{}</a> (рівень: {}) зробив вам челендж. У вас є {}\n для відповіді'
                                                    'Якщо ви не приймете цей челендж, вам буде автоматично зараховано технічну поразку в матчі!',
        ...
        'challenge_cancellation_denied_opponent_msg': 'Ваш опонент {} не готовий скасувати челендж. Зв’яжіться одне з одним, будь ласка ☎️',
        'challenge_cancellation_denied_msg': 'Ви відмовились від пропоцизії {} стосовно скасування челенджа. Зв’яжіться одне з одним, будь ласка ☎️',
        'challenge_cancellation_in_progress_msg': 'Ваш опонент {} наразі розглядає пропозицію скасування челенджа. Дочекайтесь реакції, будь ласка ☕️',
        'challenge_cancellation_opponent_is_verifying_results_msg': 'Ваш опонент {} має підтвердити результат матча. Наразі скасування челенджа неможливе 🕘',
        ...
        'error_occurred_contact_administrator_msg': 'Під час обробки вашого запиту сталася помилка. Напишіть адміністратору - @abezkorovainyi',

        'challenge_received_accept_btn': '✅ Прийняти',
        'challenge_received_dismiss_btn': '❌ Відхилити',
        ...
        'challenge_confirm_cannot_fin_opponents_user_msg': 'Неможливо провести матч - суперник більше не присутній у Telegram, нам не вдалось проінформувати його щодо челенджу',
        'challenge_confirm_challenge_canceled_by_bot_msg': 'Челендж буде скасовано автоматично. Напишіть про це адміністратору - @abezkorovainyi',
        ...
        'remainder_challenge_play_msg': 'Нагадуємо, що ви в челенджі в Піраміді. У вас залишилося днів для матчу: {}',
        ...
        'user_was_moved_to_inactive': 'Ви проігнорували надто багато челенджів. Вас переведено в стан Inactive. Для повернення до турніру зв’яжіться з адміністрацією - @abezkorovainyi',
        ...
        'gsheet_log_challenge_canceled': 'Челендж від {} до {} скасовано',
        ...
        'group_chat_match_result_msg': '🔥 Перемога {} у матчі з {} з рахунком: {}. Браво 🎾',
        'group_chat_players_level_changed': '🔺 Зміна рівнів гравців в Піраміді: {}',

        'admin_notification_competitor_changed_status': '{} змінив свій статус з {} на {}',
        'admin_notification_tg_user_vanished': 'Не вдається більше знайти {}',
        'admin_notification_tg_user_blocked': 'Не вдалося надіслати повідомлення {}, оскільки він заблокував бота.\n'
        ...
        'admin_notification_tg_user_blocked_and_competitor_vanished': 'Не вдалося надіслати повідомлення користувачу {}, оскільки він заблокував бота.\n'
                                                                      'Користувач не пов’язаний з жодним з гравців',

        'error_bot_blocked_by_opponent_challenge_canceled_msg': 'Мені не вдалось зв’язатись з вашим суперником 😹',
        'error_bot_blocked_by_opponent_challenge_canceled_contact_admin_str': 'Челендж буде скасовано автоматично. Ми надіслали сповіщення адміністратору, проте ви можете повідомити про цю проблему самостійно. Напишіть @abezkorovainyi'
    }
}
