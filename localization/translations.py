LANGUAGES_DICTIONARY = {
    'uk': {
        ...
        'authentication_msg': 'Це офіційний бот Shuliavka Pyramid Open \n'
                              'Для участі в турнірі оберіть себе зі списку гравців.\n'
                              'Якщо не можете знайти себе, зв’яжіться, будь ласка, з адміністрацією - @abezkorovainyi',
        'authentication_cannot_find_competitors_msg': 'Нових гравців турніра не знайдено 😢 \n'
                                                      'Зв’яжіться, будь ласка, з адміністрацією - @abezkorovainyi',
        'authentication_specified_competitor_not_found_clb': 'Такого учасника не знайден 😢',
        ...
        'challenge_no_applicable_competitors_msg': 'Наразі ніхто з доступних вам гравців не може отримати челендж. Дочекайтесь завершення найближчих матчів, а також поверення гравців з відпустки чи лікарняного 🙃',
        ...
        'error_bot_blocked_by_opponent_challenge_canceled_contact_admin_str': 'Челендж буде скасовано автоматично. Ми надіслали сповіщення адміністратору, проте ви можете повідомити про цю проблему самостійно @abezkorovainyi'
    }
}
